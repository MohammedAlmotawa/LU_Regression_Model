...
#The source Data
WORKBOOK1 = openpyxl.load_workbook('COData_DividedByMonth.xlsx')
SHEET1 = WORKBOOK1['1']
WORKBOOK2 = openpyxl.load_workbook('Abha.xlsx')
SHEET2 = WORKBOOK2['1']
WORKBOOK3 = openpyxl.load_workbook('Alahsa.xlsx')
SHEET3 = WORKBOOK3['1']
WORKBOOK4 = openpyxl.load_workbook('Albaha.xlsx')
SHEET4 = WORKBOOK4['1']
WORKBOOK5 = openpyxl.load_workbook('Albaha.xlsx')
SHEET5 = WORKBOOK5['1']
WORKBOOK6 = openpyxl.load_workbook('Aljouf.xlsx')
SHEET6 = WORKBOOK6['1']
WORKBOOK7 = openpyxl.load_workbook('Arar.xlsx')
SHEET7 = WORKBOOK7['1']
...
#Addin the same Headings as the original file for each sheeat
#for d in range(1,32):
#    SW1 = NE.active
#    SW1 = NE[str(d)]
...
#Moving every measurment based on the measurment month
